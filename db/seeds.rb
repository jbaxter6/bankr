...
10.times {Bank.create(name: Faker::Bank.unique.name, location: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)}
...
100.times {Transfer.create(sender: Account.all.sample, receiver: Account.all.sample, amount: rand(0.00..100.00), pending: false)}
